...
*/
package com.oltranz.paymentengen.beans;


import com.oltranz.paymentengen.entities.PaymentEngen;
...
import com.oltranz.paymentengen.model.VoucherSingle;
 ...
 */
@Stateless
public class PaymentManagerEngen {
    ...
    public PaymentResponse cashPayment(PaymentRequest paymentRequest){
        ...
        PaymentEngen payment =new PaymentEngen();
        try{
    ...
    public Voucher getVoucher(String voucherNo){
        Voucher voucher;
        try{
            String getUrl="http://localhost:8080/EngenPayFuel/VoucherManagementService/voucher/"+voucherNo;
    ...
    public Voucher editVoucher(Long voucherId,Double remainAmount){
        Voucher voucher;
        try{
            String url="http://localhost:8080/EngenPayFuel/VoucherManagementService/voucher/edit";
            String  jsonData = "{\n" +
                    "\"voucherId\":\""+voucherId+"\",\n" +
    ...
    public void momoConfirmation(ServiceProvison serviceProvisonIp){
        ...
        String url="http://localhost:8080/EngenPayFuel/AndroidWebService/pos/momoConfirmation";
        String xmlData="<COMMAND>"
