$(function () {
    ...
    $('#demo_products').highcharts({
        ...
        series: [{
            name: 'Products',
            data: [
                { name: 'Super', color: '#057ac0', y: 56.33 },
                { name: 'Gasoil', color: '#d9d928', y: 24.03 }
    ...
    $('#demo_branches').highcharts({
        ...
        $('#demo_livetransactions').highcharts({
            chart: {
                type: 'spline',
