...
function d(f){a=$.templates('<li class="myplaces-category" style="border:1px solid red"><label class="myplaces-check" for="{{:#data}}">{{:#data}}<input type="checkbox" id="{{:#data}}" /></label></li>');
e(f);
...
n();
g(q)
}function n(){var q={zoom:12,center:new google.maps.LatLng(-1.9869329, 30.0987034),mapTypeId:google.maps.MapTypeId.ROADMAP};
...
$(".myplaces-infoContenido").append('<p class="myplaces-info-results">To see the details of a BRANCH please click on it.</p>')
...
}}else{o.append('<p class="myplaces-info-results">No SP Branches in this area</p>')
...
$(".myplaces-infoContenido").empty().append('<p class="myplaces-info-results">To see the details of the BRANCH click on it.</p>')
...
a.extend(b,c);
var e='<div class="col-xs-12 col-sm-12 myplaces-searcher" style="margin:0px;padding:0px;margin-bottom:17px;"><input class="col-xs-12 col-sm-10 myplaces-searcher-input" type="text" /><button class="col-xs-12 col-sm-2 myplaces-buscar" style="border:0px solid red;">Search</button></div><ul class="myplaces-categories"></ul>  <div  class="col-xs-12" style="margin:0x;padding:0px;border:2px solid #a4b7e6;"><div class="col-xs-12 col-sm-6 myplaces-places"  style="border:0px solid green;margin:0x;padding:0px;"><div class="myplaces-placesList"><ul></ul></div><div class="myplaces-placeInfo"><div class="myplaces-infoContenido"></div></div></div><div class="col-xs-12 col-sm-6 myplaces-map"  style="border:0px solid pink;margin:0x;padding:0px;"></div>';
a(d).append(e);
