...
public class CommonLibrary {
    ...
    static public Object unmarshalling(String inputXML, Class className,String MediaType ) {
        ...
        try{
            ...
            if(MediaType.equalsIgnoreCase("jason")){
    ...
    */
    ...
    public static Response sendRESTRequest(String cmd,String domain,String url,String requestStr, String MediaType, String method)
    {
        try
        {
            ...
            switch (method){
                case "POST":
                    response = target.request().header("Content-type", "text/xml").header("Signature", "43AD232FD45FF").header("CMD", cmd).header("Domain", domain).post(Entity.entity(requestStr, MediaType));
