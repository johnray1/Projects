...
public class UserBean implements Serializable{
    ...
    public String users(){
        ...
        try{
            ...
            String url="http://localhost:8080/AirtimeRechargeSystemCore/users/list";
    ...
    public String create(){
        ...
        String url="http://localhost:8080/AirtimeRechargeSystemCore/users/newuser";
        String  jsonData ="{\n" +
    ...
    public String update(){
        ...
        String url="http://localhost:8080/AirtimeRechargeSystemCore/users/edit";
        String  jsonData ="{\n" +
                "\"createdBy\":\""+createdBy+"\",\n" +
                "\"email\":\""+email+"\",\n" +
                "\"fName\":\""+firstName+"\",\n" +
