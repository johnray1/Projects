...
import com.oltranz.engenpayfuel.models.BranchProduct;
import com.oltranz.engenpayfuel.models.BranchProductPriceModel;
import com.oltranz.engenpayfuel.models.ProductTypes;
import com.oltranz.engenpayfuel.models.Products;
...
//----------------------------------------------------BRANCH PRODUCT--------------------------------------------------------------
    ...
    public ResultObject getBranchProduct(Integer branchId,Integer productId){
        ...
        if(branchProductPrice==null){
            resultObject.setObject(null);
            resultObject.setMessage("No Branch Product Found");
            resultObject.setStatusCode(500);
            return resultObject;
        }
        else{
            ...
            resultObject.setObject(branchProductModel);
            resultObject.setMessage("Branch Product found");
            resultObject.setStatusCode(100);
            return resultObject;
        }
