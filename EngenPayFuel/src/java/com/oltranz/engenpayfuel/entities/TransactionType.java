 ...
 */
@Entity
@Table(name = "transaction_type", catalog = "EngenPayFuelDB", schema = "")
@XmlRootElement
@NamedQueries({
    ...
    @NamedQuery(name = "TransactionType.findByDescr", query = "SELECT t FROM TransactionType t WHERE t.descr = :descr")})
public class TransactionType implements Serializable {
    ...
    public String toString() {
        return "com.oltranz.engenpayfuel.entities.TransactionType[ id=" + id + " ]";
    }
