 ...
 */
@Entity
@Table(name = "branch_product_price", catalog = "EngenPayFuelDB", schema = "")
@XmlRootElement
@NamedQueries({
...
public class BranchProductPrice implements Serializable {
    ...
    public String toString() {
        return "com.oltranz.engenpayfuel.entities.BranchProductPrice[ branchProductPricePK=" + branchProductPricePK + " ]";
    }
