 ...
 */
@Entity
@Table(name = "product_type", catalog = "EngenPayFuelDB", schema = "", uniqueConstraints = {
...
public class ProductType implements Serializable {
    ...
    public String toString() {
        return "com.oltranz.engenpayfuel.entities.ProductType[ productTypeId=" + productTypeId + " ]";
    }
