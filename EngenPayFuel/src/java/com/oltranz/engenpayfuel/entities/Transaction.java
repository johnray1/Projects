 ...
 */
@Entity
@Table(name = "transaction", catalog = "EngenPayFuelDB", schema = "", uniqueConstraints = {
...
public class Transaction implements Serializable {
    ...
    public String toString() {
        return "com.oltranz.engenpayfuel.entities.Transaction[ transactionId=" + transactionId + " ]";
    }
