 ...
 */
@Entity
@Table(name = "action_on_object_result", catalog = "PayFuelDB", schema = "")
@XmlRootElement
@NamedQueries({
...
public class ActionOnObjectResult implements Serializable {
    ...
    public String toString() {
        return "com.oltranz.payfuel.entities.ActionOnObjectResult[ actionOnObjectResultPK=" + actionOnObjectResultPK + " ]";
    }
