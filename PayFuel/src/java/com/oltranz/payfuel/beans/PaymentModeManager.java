...
public class PaymentModeManager {
    ...
    public ResultObject getPaymentModeList(){
        ...
        List<PaymentMode> paymentModeList=(List<PaymentMode>)em.createNamedQuery("PaymentMode.findAll").getResultList();
    ...
    public ResultObject getPaymentModeByUserId(Integer userId){
        ...
        if(user==null){
            resultObject.setMessage("User is not Created To Access The PaymentMode");
            resultObject.setObject(null);
            return resultObject;
        }
